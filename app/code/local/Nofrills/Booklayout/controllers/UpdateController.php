...
class Nofrills_Booklayout_UpdateController extends Mage_Core_Controller_Front_Action
{
	...
	{	/*Capitulo anterior al 2.4*/
		...
		/*Es importante que se realice la inserci�n del bloque despues siempre de llamar al m�todo
		 * generateBlocks(), ya que si no dar� un error y dir� que estamos llamando a un objeto vacio.*/
		$layout->generateBlocks();
